#ifndef OFCCL_PRIMITIVES_H_
#define OFCCL_PRIMITIVES_H_
...
struct ProtoSimple {
  ...
  __device__ static int calcBytePerStep() {
    return sharedCollCtx[blkStatus.currLoadedCollId % NUM_SHMEM_SLOT].buffSizes[NCCL_PROTO_SIMPLE]/NCCL_STEPS;
  }
